/*******************************************************
* zconv2D_O.c - Written by Jason Laska
*
...
*
* Version 2.0: Bug Fix on 1/10/04 by Jason Laska
*
        ...
        for(n2=0; n2<SColLength; n2++)
        {
            ...
            {   
                ...
                for(l2=0; l2<FColLength; l2++)
                {
                    ...
                    if(indexx < 0)
                        indexx += SRowLength;
                    if(indexx > (SRowLength-1))/*Extra Condititon for Negs*/
                        indexx -= SRowLength;
                    indexy -= M3;    
                    if(indexy < 0)
                        indexy += SColLength;
                ...
                if(outindexy > (SColLength-1))/*Extra Condition for Negs*/
                    outindexy -= SColLength;
            }
