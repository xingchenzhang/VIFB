...
% Simulation code for [1], presented in ICIP'14 (http://icip2014.wp.mines-telecom.fr/)
%
% [1] Paul Rodriguez, Brendt Wohlberg "Performance Comparison Of Iterative Reweighting 
%                                      Methods For Total Variation Regularization"
%                     accepted 2014 International Conference on Image 
%                     Processing (ICIP'14), Paris, France, 2014.
%  
...
% Setup simulation
if( strcmp(example, 'icip14') )

  disp('  Running the "icisp14" example...');
  ...
  if( ~strcmp(myImg, 'all') ) 
    ...
    disp('NOTE:');
    disp('  If you run the "icip14" example, you should set Img = "all" ...');
